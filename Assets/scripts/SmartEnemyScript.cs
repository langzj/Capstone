...
public class SmartEnemyScript : MonoBehaviour {
    ...
    private EvasiveManeuver evadeScript;
    ...
    void Awake()
    {
        ...
        // The evade script is called
        evadeScript = GetComponent<EvasiveManeuver>();

        

        //This allows both collider and renderer to be invoked
        // which involes the physics engine component of Unity2D
        ...
        else
        {
            ...
            foreach (WeaponScript weapon in weapons)
            {
                if (weapon != null && weapon.enabled && weapon.CanAttack)
                {
                    ...
                    weapon.Attack(true);
                    // Sound initiated
                    SoundEffectsHelper.Instance.MakeEnemyShotSound2();
                }
            }
